...
from SequenceGan.configuration import training_config,generator_config,discriminator_config
from SequenceGan.dataloader import Gen_Data_loader,Dis_dataloader
from SequenceGan.generator import Generator
from SequenceGan.rollout import rollout
from SequenceGan.discriminator import Discriminator
import pickle
from SequenceGan.target_lstm import TARGET_LSTM
from SequenceGan.utils import generate_samples,target_loss
...
def main(unused_argv):
    # config.py中存储的是各个阶段需要的初始化数据或者训练用参数
